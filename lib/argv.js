...
var argv = require('yargs') // TODO use rather option('o', hash) syntax and define default top-level command
  ...
  .alias('x', 'spider')
  .describe('x', 'Triggers spider functionality (discover and visit all urls). When given a (numerical) value, it caps the crawling to a maximum amount of urls defined by that value. Any value below zero is regarded as infinite (no maximum), which is also the default behaviour')
  // for default, see lib/tools.js:getSpiderValue()
  .number('x')
