...
// use in shell for development:
// while inotifywait -e modify assets/template.pug; do ./create-html.js output_bild/inspection.json > output_bild/inspection.html; done
